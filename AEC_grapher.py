...
IQF_from_bright_grid = iqf_from_bright_interpolator(points_grid_bright_kv).reshape(BRIGHT_grid.shape)
...
surf3 = ax3.plot_surface(MAS_grid, KV_grid, IQF_dose_grid, cmap='coolwarm', edgecolor='none')
ax3.set_xlabel('мАс')
ax3.set_ylabel('кВ')
ax3.set_zlabel('IQF/доза')
ax3.set_title('IQF/доза = f(мАс, кВ)')
