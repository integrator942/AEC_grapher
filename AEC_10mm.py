...
data = {
    100: {
        'мАс': [0.32, 0.63, 1.0, 1.25, 1.6, 2.5, 4.0],
        'IQF': [3.1, 4.88, 6.33, 6.37, 7.08, 7.52, 8.16],
        'Яркость': [464.0, 835.0, 1297.0, 1600.0, 2030.0, 3146.0, 5007.0],
        'Доза': [4.9, 9.57, 15.1, 18.9, 24.2, 37.9, 60.7]
    },
    110: {
        'мАс': [0.25, 0.5, 0.8, 1.0, 1.6, 2.0, 3.2],
        'IQF': [3.01, 4.8, 5.96, 6.51, 7.26, 7.46, 8.12],
        'Яркость': [484.0, 890.0, 1380.0, 1711.0, 2714.0, 3374.0, 5383.0],
        'Доза': [4.6, 9.51, 14.3, 18.4, 28.8, 36.0, 57.6]
    },
    120: {
        'мАс': [0.2, 0.4, 0.63, 0.8, 1.25, 1.6, 2.5],
        'IQF': [2.67, 5.1, 5.86, 6.5, 7.22, 7.41, 8.07],
        'Яркость': [494.0, 906.0, 1390.0, 1752.0, 2701.0, 3449.0, 5383.0],
        'Доза': [4.41, 8.65, 13.2, 17.0, 26.1, 33.4, 52.1]
    }
}
